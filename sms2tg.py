...
def set_bot_commands():
    ...
    commands = [
        {"command": "filter_list", "description": "View and edit the list of filtered senders"}
    ]
        ...
        if updates and updates.get("ok"):
            for update in updates.get("result", []):
                ...
                if "message" in update and "text" in update["message"]:
                    ...
                    if command == "/filter_list":
                        # Send the list of filtered senders
                        if not filtered_addresses:
                            send_telegram_message("There are no filtered senders.")
                        else:
                            text = "Click on sender to unfilter\n"
                            inline_keyboard = []
                ...
                if "callback_query" in update:
                    ...
                    elif callback_data and callback_data.startswith("unfilter:"):
                        sender_to_unfilter = callback_data.split(":")[1]
